...
import { buildAutoPlacementLockPatch } from "../app/parts/item-edit/item-edit.auto-placement";

const gridPatch = buildAutoPlacementLockPatch({
	capsuleType: CAPSULE_TYPES.GRILLE,
	targetDecor: { id: 1, area: null, className: "", style: {} } as any,
	snapshot: {
		className: "cell_auto_grille-r2-c3",
		gridRowStart: "2",
		gridColumnStart: "3"
	}
});
...
const listPatch = buildAutoPlacementLockPatch({
...
const noPatchWhenAreaAlreadySet = buildAutoPlacementLockPatch({
	capsuleType: CAPSULE_TYPES.GRILLE,
